  ...
  private static generateBoards() {
    return [
      ...
      new Board([
        ...
        [this.cards[5], this.cards[1], this.cards[33], this.cards[2]]]),
      new Board([
        ...
        [this.cards[33], this.cards[25], this.cards[29], this.cards[27]]]),
      new Board([
      ...
      new Board([
        ...
        [this.cards[31], this.cards[11], this.cards[8], this.cards[12]],
      ...
      new Board([
        ...
        [this.cards[10], this.cards[13], this.cards[31], this.cards[15]],
